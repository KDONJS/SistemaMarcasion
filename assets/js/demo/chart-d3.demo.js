var handleLineChart = function () {
  ...
  nv.addGraph(function () {
    ...
    var lineChart = nv.models
      .lineChart()
      .options({ transitionDuration: 300, useInteractiveGuideline: true });
...
var handleStackedBarChart = function () {
  ...
  nv.addGraph({
    generate: function () {
      var stackedBarChart = nv.models
        .multiBarChart()
        .stacked(true)
        .showControls(false);
      var svg = d3
        .select("#nv-stacked-bar-chart")
        .append("svg")
