    ...
    nv.models.tooltip = function() {
        ...
        */
        ...
        nvtooltip._options = Object.create({}, {
            ...
            offset: {
                get: function() { return { left: 0, top: 0 }; },
                set: function(_) {
                    // deprecated after 1.8.1
    ...
    */
    ...
    nv.models.focus = function(content) {
        ...
        chart._options = Object.create({}, {
            ...
            interpolate: {
                get: function() { return content.interpolate(); },
                set: function(_) {
                    content.interpolate(_);
                }
            },
            xTickFormat: {
                get: function() { return xAxis.tickFormat(); },
                set: function(_) {
                    xAxis.tickFormat(_);
                }
            },
            yTickFormat: {
                get: function() { return yAxis.tickFormat(); },
                set: function(_) {
                    yAxis.tickFormat(_);
                }
            },
            x: {
                get: function() { return content.x(); },
                set: function(_) {
                    content.x(_);
                }
            },
            y: {
                get: function() { return content.y(); },
                set: function(_) {
                    content.y(_);
                }
            },
    ...
    nv.models.forceDirectedGraph = function() {
        ...
        chart._options = Object.create({}, {
            ...
            noData: { get: function() { return noData; }, set: function(_) { noData = _; } },
            nodeExtras: {
                get: function() { return nodeExtras; },
                set: function(_) {
                    nodeExtras = _;
                }
            },
            linkExtras: {
                get: function() { return linkExtras; },
                set: function(_) {
                    linkExtras = _;
                }
            }
    ...
    nv.models.lineChart = function() {
        ...
        chart._options = Object.create({}, {
            ...
            interpolate: {
                get: function() { return lines.interpolate(); },
                set: function(_) {
                    lines.interpolate(_);
                    focus.interpolate(_);
                }
    ...
    nv.models.linePlusBarChart = function() {
        ...
        chart._options = Object.create({}, {
            ...
            switchYAxisOrder: {
                get: function() { return switchYAxisOrder; },
                set: function(_) {
    ...
    nv.models.parallelCoordinates = function() {
        ...
        chart._options = Object.create({}, {
            ...
            // deprecated options
            dimensions: {
                get: function() { return dimensionData.map(function(d) { return d.key }); },
                set: function(_) {
                    // deprecated after 1.8.1
            ...
            dimensionFormats: {
                get: function() { return dimensionData.map(function(d) { return d.format }); },
                set: function(_) {
                    // deprecated after 1.8.1
    ...
    nv.models.pie = function() {
        ...
        chart._options = Object.create({}, {
            ...
            pieLabelsOutside: {
                get: function() { return labelsOutside; },
                set: function(_) {
                    labelsOutside = _;
