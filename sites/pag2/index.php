...
<link rel="icon" type="image/png" href="/1.-Herramientas/1.-Imagenes/logo__.png" />
	...
	<section class="full-width pageContent">
			<nav aria-label="breadcrumb">
			  <ol class="breadcrumb">
			    ...
			    <li class="breadcrumb-item active" aria-current="page">AFP INTEGRA</li>
			  </ol>
			</nav>
		<section class="full-width text-center" style="padding: 40px 0;">
			...
			<div class="slider-holder">
		        ...
		        <div class="image-holder">
		            <img src="/1.-Herramientas/1.-Imagenes/Jefaturas/2.-Ima.jpg" class="slider-image" class="img-responsive" />
		        </div>
    		</div>
    		...
    		<!--
    		<div  class="image-holder">
    			<img src="chile2.gif" style="width: 75px; height:50px " alt="Cargando..." />
			</div>
			-->
