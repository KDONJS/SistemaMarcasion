$(document).ready(function(){
    ...
    $('.btn-exit').on('click', function(){
    	swal({
		  	title: 'Deseas salir de Zeus ?',
		 	text: "Recuerda que debes volverte a loguear para el ingreso",
		  	type: 'warning',
    ...
    /*Bienvenida de Portal*/
    $('.btn-hola').on('click', function(){
        swal({
            title: ' Bienvenido al dQuery!',
            text: " Encuentra toda la informacion que necesites y mantente al tanto de las nuevas publicaciones" ,
