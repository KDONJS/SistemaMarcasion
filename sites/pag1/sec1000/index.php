...
<html ng-app="angularApp">
  <body ng-controller="MyCtrl">
     <form name="myForm" > 
        <input  class="input-group-addon" type="date" ng-model="date" max="{{maxDateStr}}" name="dateInput" id="dateInput">
          ...
          <div class="panel">
            ...
            <div class="panel-body"  style="text-align: center;">
              <table class="  nowrap hover  " id="tablaJson"  >
                <thead>
                  <tr>
                    <th style="color:#b0b0b0";>DNI</th>
                    <th  style="color:#b0b0b0";>AGENTE</th>
                    <th>SUPERVISOR</th>
                    <th>Atendidas</th>
                    <th>Atendidas_30</th>
                    <th>Abandonada</th>
...
<script src="../../../assets/plugins/bootstrap-timepicker/js/bootstrap-timepicker.min.js" type="cd79dd05cafda7be68ceda67-text/javascript"></script>
