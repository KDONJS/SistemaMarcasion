...
include '../../../../3.-Conexiones/4.-Inactivo.php';
	...
	<section class="full-width pageContent">
			<nav aria-label="breadcrumb">
			  <ol class="breadcrumb">
			    ...
			    <li class="breadcrumb-item"><a href="/4.-Diseño/indexluis.php">3M</a></li>
			    <li class="breadcrumb-item"><a href="/4.-Diseño/indexluis.php">Area1</a></li>
			    <li class="breadcrumb-item active" aria-current="page">Vista1</li>
			  </ol>
			</nav>
