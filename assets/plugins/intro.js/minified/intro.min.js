!(function (t) {
  ...
  function e(t, i) {
    ...
    if (this._options.steps)
      ...
      B(
        ...
        function (t) {
          if (
            (!i || t.getAttribute("data-intro-group") === i) &&
            ...
            (o =
              ...
              0 < e &&
                (n[e - 1] = {
                  ...
                  scrollTo:
                    t.getAttribute("data-scrollto") || this._options.scrollTo,
  ...
  function c(t) {
    ...
    if (
      ...
      if ("ArrowLeft" === e || 37 === e) N.call(this);
        ...
        i && i.className.match("introjs-prevbutton")
          ? N.call(this)
          : i && i.className.match("introjs-skipbutton")
          ...
          : i && i.getAttribute("data-stepnumber")
          ? i.click()
          : E.call(this),
  ...
  function h(t) {
    ...
    var e = {};
    for (var i in t)
      void 0 !== window.jQuery && t[i] instanceof window.jQuery
        ? (e[i] = t[i])
        : (e[i] = h(t[i]));
    return e;
  }
  function E() {
        ...
        B(
          ...
          function (t, e) {
            t.step === this._currentStepNumber &&
              ((this._currentStep = e - 1), (this._currentStepNumber = void 0));
          }.bind(this)
        ),
    ...
    return (
      ...
      !1 === e
        ...
        ? ("function" == typeof this._introCompleteCallback &&
            this._introCompleteCallback.call(this),
          void A.call(this, this._targetElement))
        : void i.call(this, t)
    );
  }
  function N() {
  ...
  function A(t, e) {
    ...
    if (
      (void 0 !== this._introBeforeExitCallback &&
        (i = this._introBeforeExitCallback.call(this)),
      e || !1 !== i)
    ) {
  ...
  function L(t, e, i, n, o) {
    ...
    if (
      ...
      null != n && ((n.style.top = null), (n.style.left = null)),
      this._introItems[this._currentStep])
    )
      switch (
        ((h =
          "string" ==
          typeof (s = this._introItems[this._currentStep]).tooltipClass
            ? s.tooltipClass
        ...
        case "top-middle-aligned":
          ...
          o && (d += 5),
            f(r, d, l, e) && ((e.style.right = null), p(r, d, l, a, e)),
        ...
        case "right":
          (e.style.left = r.width + 20 + "px"),
            r.top + l.height > a.height
              ? ((i.className = "introjs-arrow left-bottom"),
                (e.style.top = "-" + (l.height - r.height - 20) + "px"))
  ...
  function p(t, e, i, n, o) {
    return t.left + e + i.width > n.width
      ? ((o.style.left = n.width - i.width - t.left + "px"), !1)
      : ((o.style.left = e + "px"), !0);
  }
  function f(t, e, i, n) {
    return t.left + t.width - e - i.width < 0
      ? ((n.style.left = -t.left + "px"), !1)
      : ((n.style.right = e + "px"), !0);
  }
  function m(t, e) {
  ...
  function T(t) {
    if (t) {
      ...
      d(e.element)
        ? H(t, "introjs-fixedTooltip")
        : O(t, "introjs-fixedTooltip"),
  ...
  function i(o) {
    void 0 !== this._introChangeCallback &&
      this._introChangeCallback.call(this, o.element);
    var t,
      e,
      i,
      n,
    ...
    if (
      ("string" == typeof o.highlightClass && (a += " " + o.highlightClass),
      "string" == typeof this._options.highlightClass &&
        (a += " " + this._options.highlightClass),
      null !== l)
    ) {
      ...
      if (
        ((i = r.querySelector(".introjs-skipbutton")),
        ...
        ((null !== p &&
          ...
          "floating" === p.position) ||
          ("backward" === this._direction && "floating" === o.position)) &&
          (c.style.opacity = 0);
      }
      (n = R(o.element)) !== document.body && V(n, o.element),
        ...
        (s._lastShowElementTimer = window.setTimeout(function () {
          null !== c && (c.innerHTML = o.step),
            ...
            s._options.showBullets &&
              ((r.querySelector(".introjs-bullets li > a.active").className =
                ""),
              (r.querySelector(
                '.introjs-bullets li > a[data-stepnumber="' + o.step + '"]'
              ).className = "active")),
            (r.querySelector(
              ".introjs-progress .introjs-progressbar"
            ).style.cssText = "width:" + z.call(s) + "%;"),
            r
              .querySelector(".introjs-progress .introjs-progressbar")
              .setAttribute("aria-valuenow", z.call(s)),
            (d.style.opacity = 1),
            c && (c.style.opacity = 1),
      ...
      (f.className = a),
        ...
        (y.innerHTML = o.intro),
        !(v.className = "introjs-bullets") === this._options.showBullets &&
      ...
      B(this._introItems, function (t, e) {
        ...
        v.appendChild(C),
        !(_.className = "introjs-progress") === this._options.showProgress &&
      ...
      (k.className = "introjs-progressbar"),
        ...
        !(w.className = "introjs-tooltipbuttons") ===
          this._options.showButtons && (w.style.display = "none"),
      ...
      !0 === this._options.showStepNumbers &&
        ...
        (i.onclick = function () {
          s._introItems.length - 1 === s._currentStep &&
            "function" == typeof s._introCompleteCallback &&
            s._introCompleteCallback.call(s),
            s._introItems.length - 1 !== s._currentStep &&
              "function" == typeof s._introExitCallback &&
              s._introExitCallback.call(s),
            "function" == typeof s._introSkipCallback &&
              s._introSkipCallback.call(s),
            A.call(s, s._targetElement);
        }),
        w.appendChild(i),
        1 < this._introItems.length && (w.appendChild(e), w.appendChild(t)),
        g.appendChild(w),
    ...
    S && S.parentNode.removeChild(S),
      ...
      0 === this._currentStep && 1 < this._introItems.length
        ? (null != i &&
            (i.className = this._options.buttonClass + " introjs-skipbutton"),
          null != t &&
            (t.className = this._options.buttonClass + " introjs-nextbutton"),
          !0 === this._options.hidePrev
            ? (null != e &&
                (e.className =
                  this._options.buttonClass +
                  " introjs-prevbutton introjs-hidden"),
              null != t && H(t, "introjs-fullbutton"))
            : null != e &&
              (e.className =
                this._options.buttonClass +
        ...
        ? (null != i &&
          ...
          null != e &&
            (e.className = this._options.buttonClass + " introjs-prevbutton"),
          !0 === this._options.hideNext
            ? (null != t &&
                (t.className =
                  this._options.buttonClass +
                  " introjs-nextbutton introjs-hidden"),
              null != e && H(e, "introjs-fullbutton"))
            : null != t &&
              (t.className =
                this._options.buttonClass +
      ...
      (function (t) {
        ...
        if (t.element instanceof SVGElement)
          for (
            ...
            "svg" === e.tagName.toLowerCase() &&
              H(e, "introjs-showElement introjs-relativePosition"),
              (e = e.parentNode);
        ...
        "absolute" !== i &&
          "relative" !== i &&
          "fixed" !== i &&
          H(t.element, "introjs-relativePosition");
        e = t.element.parentNode;
        for (
          ;
          ...
          var n = M(e, "z-index"),
            ...
            s =
              M(e, "transform") ||
              M(e, "-webkit-transform") ||
              M(e, "-moz-transform") ||
              M(e, "-ms-transform") ||
              M(e, "-o-transform");
          (/[0-9]+/.test(n) || o < 1 || ("none" !== s && void 0 !== s)) &&
            H(e, "introjs-fixParent"),
            (e = e.parentNode);
        }
      })(o),
      void 0 !== this._introAfterChangeCallback &&
        this._introAfterChangeCallback.call(this, o.element);
  }
  function P(t, e, i) {
    var n, o, s;
    if (
      ...
      (o = e.element),
      !(
        0 <= (s = o.getBoundingClientRect()).top &&
        0 <= s.left &&
      ...
      var l = b().height;
      n.bottom - (n.bottom - n.top) < 0 || e.element.clientHeight > l
        ? window.scrollBy(
            0,
            n.top - (l / 2 - n.height / 2) - this._options.scrollPadding
          )
        : window.scrollBy(
            0,
            n.top - (l / 2 - n.height / 2) + this._options.scrollPadding
      ...
      (this._id = function (t, e, i, n) {
        ...
        (this.on = function (e, t, i, n, o) {
          ...
          "addEventListener" in e
            ...
            : "attachEvent" in e && e.attachEvent("on" + t, l),
            (e[r] = e[r] || {}),
            (e[r][s] = l);
        }),
  ...
  function d(t) {
    var e = t.parentNode;
    return (
      !(!e || "HTML" === e.nodeName) && ("fixed" === M(t, "position") || d(e))
    );
  }
  function b() {
  ...
  function l(t) {
    ...
    (function () {
      ...
      null === r &&
        ((r = document.createElement("div")).className = "introjs-hints");
      B(
        this._introItems,
        function (t, e) {
    ...
    B(
      ...
      function (t) {
        void 0 !== t.targetElement &&
          C.call(this, t.hintPosition, t.element, t.targetElement);
      }.bind(this)
    );
  }
  function y(t) {
  ...
  function j(t) {
    ...
    void 0 !== this._hintClickCallback &&
      this._hintClickCallback.call(this, e, i, t);
    var n = g.call(this);
    if (parseInt(n, 10) !== t) {
      var o = document.createElement("div"),
  ...
  function R(t) {
    ...
    for (var o = t; (o = o.parentElement); )
      if (
        ...
        (!i || "static" !== e.position) &&
          n.test(e.overflow + e.overflowY + e.overflowX))
      )
        return o;
        ...
        return (
          function () {
            ...
            t && t.length
              ...
              : l.call(this, this._targetElement);
          }.call(this),
          this
        );
      },
