	...
	<section class="full-width pageContent">
		<nav aria-label="breadcrumb">
			  <ol class="breadcrumb">
			    ...
			    <li class="breadcrumb-item"><a href="../../design/indexluis.php">Pool de Pases</a></li>
			    <li class="breadcrumb-item active" aria-current="page">Programación de Pases</li>
			  </ol>
			</nav>
		<section class="full-width text-center" style="padding: 40px 0;">
			...
			<div class="slider-holder">
		        ...
		        <div class="image-holder">
		            <img src="/tools/img/Leadership/1.-Programa/1.-Programa.jpg" class="slider-image" class="img-responsive" />
		        </div>
    		</div>
